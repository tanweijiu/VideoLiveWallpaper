...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_initVideo(JNIEnv * env, jobject this)
{
	initializedVideo = 0;
	initializedFrame = 0;
}
...
/* pCodecCtx */
/* pFormatCtx */
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_loadVideo(JNIEnv * env, jobject this, jstring fileName)
{
	jboolean isCopy;
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_prepareStorageFrame(JNIEnv * env, jobject this)
{
...
jint Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_getVideoWidth(JNIEnv * env, jobject this)
{
	return pCodecCtx->width;
}

jint Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_getVideoHeight(JNIEnv * env, jobject this)
{
	return pCodecCtx->height;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_getFrame(JNIEnv * env, jobject this)
{
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setLoopVideo(JNIEnv * env, jobject this, jboolean b)
{
	loopVideo = b;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_closeVideo(JNIEnv * env, jobject this)
{
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_freeVideo(JNIEnv * env, jobject this)
{
	if (initializedVideo == 1)
	{
		/* // Free the YUV frame */
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_freeConversionStorage(JNIEnv * env, jobject this)
{
	if (initializedFrame == 1)
	{
		// Free the converted image
...
static GLuint s_disable_options[] = { GL_FOG, GL_LIGHTING, GL_CULL_FACE, GL_ALPHA_TEST, GL_BLEND, GL_COLOR_LOGIC_OP, GL_DITHER, GL_STENCIL_TEST, GL_DEPTH_TEST, GL_COLOR_MATERIAL, 0 };

// For stuff that opengl needs to work with,
// like the bitmap containing the texture
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_initPreOpenGL(JNIEnv * env, jobject this)
{
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_initOpenGL(JNIEnv * env, jobject this)
{
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_updateVideoPosition(JNIEnv * env, jobject this)
{
	if (spanVideo == JNI_FALSE || isPreview == JNI_TRUE)
		return;
	screenR = xOffSet + xStep;
	videoR = marginX + wallVideoWidth;
	if ((screenR > marginX) && (xOffSet < videoR))
	{
		//find % of video to display
		int left = max(xOffSet,marginX);
		int right = min(screenR,videoR);
		textureL = ((float) (left - marginX) / (float) wallVideoWidth) * textureWidth;
		textureR = ((float) (right - marginX) / (float) wallVideoWidth) * textureWidth;
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_drawFrame(JNIEnv * env, jobject this)
{
	...
	if (spanVideo == JNI_TRUE && isPreview == JNI_FALSE)
	{
		...
		0, /* xoffset */
		0, /* yoffset */
		textureWidth, textureHeight, GL_RGBA, /* format */
		GL_UNSIGNED_BYTE, /* type */
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_closeOpenGL(JNIEnv *env, jobject this)
{
	glDeleteTextures(1, &texturesConverted[len]);
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_closePostOpenGL(JNIEnv *env, jobject this)
{
	//free(s_pixels);
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setScreenDimensions(JNIEnv *env, jobject this, jint w, jint h)
{
	screenWidth = w;
	screenHeight = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setTextureDimensions(JNIEnv *env, jobject this, jint px, jint py)
{
	textureWidth = px;
	textureHeight = py;
	nTextureHeight = -1 * py;
...
void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setWallVideoDimensions(JNIEnv *env, jobject this, jint w, jint h)
{
	wallVideoWidth = w;
	wallVideoHeight = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setWallDimensions(JNIEnv *env, jobject this, jint w, jint h)
{
	wallWidth = w;
	wallHeight = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setVideoMargins(JNIEnv *env, jobject this, jint w, jint h)
{
	marginX = w;
	marginY = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setOffsets(JNIEnv *env, jobject this, jint x, jint y)
{
	xOffSet = x;
	yOffSet = y;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setSteps(JNIEnv *env, jobject this, jint xs, jint ys)
{
	xStep = xs;
	yStep = ys;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setSpanVideo(JNIEnv *env, jobject this, jboolean b)
{
	spanVideo = b;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setDrawDimensions(JNIEnv *env, jobject this, jint w, jint h)
{
	drawWidth = w;
	drawHeight = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setScreenPadding(JNIEnv *env, jobject this, jint w, jint h)
{
	dPaddingX = w;
	dPaddingY = h;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setOrientation(JNIEnv *env, jobject this, jboolean b)
{
	isScreenPortrait = b;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_setPreviewMode(JNIEnv *env, jobject this, jboolean b)
{
	isPreview = b;
}

void Java_ffvideolivewallpaper_frankandrobot_com_NativeCalls_toggleGetFrame(JNIEnv *env, jobject this, jboolean b)
{
	isGetFrame = b;
}
